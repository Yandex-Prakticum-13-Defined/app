...
import {
  getProfile, getUser, postProfile, postUser
} from '../../api/api';
...
const Profile = () => {
  ...
  const user = postProfile({ login: 'Testt' });
  const profile = getProfile('28506');
  const pr = getUser();
  // const user = postProfile('Testt');
  // return user;
  ...
  return (
    <div className='container'>
      <form className='form' onSubmit={handleSubmit}>
        ...
        <Button type='submit' title='Profile' onClick={(e: any) => handleSubmit(e)}
